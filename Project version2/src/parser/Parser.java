...
public class Parser {
    ...
    public void parse() throws DeclarationException, TypeMismatchException {
    ...
    private void doSemantics(List<String> functions) throws DeclarationException, TypeMismatchException {
        if (debugMode) {
