...
public class CodeGenerator implements parser.CodeGenerator {
    ...
    public void doSemantic(String sem) throws DeclarationException, TypeMismatchException {
        ...
        switch (sem) {
            ...
            case "mpdscp": {//new
                System.out.println("mpdscp id running...");
                String type = (String) semanticStack.pop();
            ...
            case "start_lable_function": {//new
                if (scopeStacks.peek() instanceof MethodDescriptor && ((MethodDescriptor) scopeStacks.peek()).scopeName.equals("main"))
                    break;//mips
            }
            case "end_meth": {//new
                if (scopeStacks.peek() instanceof MethodDescriptor) {
            ...
            case "fetch_param": {//new
                ...
                //Descriptor parameter= (Descriptor) semanticStack.pop();//descriptor ya ?? (EXPRESSION)
                    ...
                    if(i==parameters.size())
                        ...
                        if (old_descriptor instanceof Descriptor) {
                            ...
                            if (new_parameter instanceof Descriptor){
                                ...
                                if (!(symbolTable.get(old_descriptor).type.equals((symbolTable.get(new_parameter).type))))
                                    throw new TypeMismatchException("fetch parameter types are not matched!");
                                switch (symbolTable.get(old_descriptor).type) {
                                    case "int":
                                    case "real":
    ...
    private void extracted12() throws TypeMismatchException {
    ...
    private void extracted5() throws TypeMismatchException {
        ...
        if (lexical.currentSymbol.getTokenName().equals("Identifier")) {
            if (inDCL) {
                ...
                if (symbolTable.containsKey(lexical.currentSymbol.getValue().toString()))
                    ...
                    else throw new DeclarationException("The variable have not exist yet!");
                }
            }
